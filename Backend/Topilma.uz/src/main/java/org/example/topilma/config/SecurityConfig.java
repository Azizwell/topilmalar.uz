  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    http
            ...
            .authorizeHttpRequests(authorizeRequests ->
                    authorizeRequests
                            .requestMatchers(HttpMethod.GET, "/api/carousel", "/api/region_stat", "/api/statistic", "/api/region", "/api/district", "/api/item", "/api/market").permitAll()
                            .requestMatchers(HttpMethod.GET, "/api/applicant").permitAll()
                            .requestMatchers(HttpMethod.PATCH, "/api/reestr").permitAll()
